...
import com.rief.viewmodel.FollowingViewModel
import com.rief.adapter.MainAdapter
import com.rief.databinding.FragmentFollowerFollowingBinding

class FollowingFragments : Fragment(R.layout.fragment_follower_following) {
	...
	override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
		...
		loadingTime(true)
		model = ViewModelProvider(this, ViewModelProvider.NewInstanceFactory())[FollowingViewModel::class.java]
